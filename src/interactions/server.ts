import { ChatInputCommandInteraction, EmbedBuilder, ChannelType, Guild } from 'discord.js';

export async function serverCommand(interaction: ChatInputCommandInteraction) {
